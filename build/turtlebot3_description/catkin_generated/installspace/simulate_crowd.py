...
class Moving():
        ...
        try:
            ...
            while not rospy.is_shutdown():
                try:
                    ...
                    self.move_model('obstacle_9', self.model_9_pose, 0, 0, 0)
                    self.move_model('obstacle_10', self.model_10_pose, 0, 0, 0)
                    self.move_model('obstacle_11', self.model_11_pose, 0, 0, 0)
                    self.move_model('obstacle_12', self.model_12_pose, 0, 0, 0)
                    self.move_model('obstacle_13', self.model_13_pose, 0, 0, 0)
                    self.move_model('obstacle_14', self.model_14_pose, 0, 0, 0)
                    # add
                    break
    ...
    def moving_1(self):
        ...
        random_vel_x = [random.uniform(-0.03, 0.03) for i in range(14)]  # Default: +/- 0.254
        random_vel_y = [random.uniform(-0.03, 0.03) for i in range(14)]  # Default: +/- 0.254  0.15
        random_vel_x = [0] * 14
        random_vel_y = [0] * 14
        # while True:
